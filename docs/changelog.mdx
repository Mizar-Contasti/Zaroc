...
> - 🎉 Zaroc 1.5 is the final version of the project
> - ✅ All integrations for Web, WhatsApp, Facebook, and Telegram have been implemented
> - ✅ Complete documentation updated


### 🎉 Releases

#### V-1.5 (06/2025) - Final Version [DOWNLOAD](https://drive.google.com/drive/folders/1iSrZkVtugXmTMYwSMe7jY6h_BAcGyljQ?usp=sharing)

> - Significant improvements in error handling and data validation across all built-in functions
> - Performance optimization and response time reduction
> - New functions for telephony integration: triggerPhoneMessage and triggerSSML
> - Better compatibility with multiple platforms (Dialogflow Messenger, Facebook, WhatsApp, Telegram)
> - Complete documentation updated with improved code examples
> - Minor bug fixes and stability improvements
> - Preparation to facilitate migration to Dialogflow CX
> - This is the final version of Zaroc
...
> - New structure for Context and Sessions, oriented to an smoother experience to Df CX migration
