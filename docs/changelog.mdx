...
> - Context functionalities able to indentify main context
> - New Functionlities folder (This folder will include some functionalities with a plug and play integration)
> - Transcript funcionality will be implemented as a Functionality
> - Zoom meetings integration will be implemented as a Functionality
> - Zaroc.jar (Java) - **Alpha** (Currently In Progress)
