...
Get started by **creating your chatbot through Dialogflow and connecting it to Zaroc**.

Or **Look at these 2 Tutorials in Spanish** with Mizar **[Tutorial 1](https://www.youtube.com/watch?v=g1GOz8o-zzY&list=PLpVijIXbyeMO5OwECKbsIbGI1k2jvKnSX&index=21)**
**[Tutorial 2](https://www.youtube.com/watch?v=426Ltaeferk&list=PLpVijIXbyeMO5OwECKbsIbGI1k2jvKnSX&index=22)**.

## 1.- Create a Chatbot on Dialogflow

First, let’s create our chatbot on Dialogflow [**HERE**](https://dialogflow.cloud.google.com/)
...
> - If you are new in Dialogflow I recommend this Youtube Channel that have good to know Tutorials from zero to Hero [**HERE**](https://www.youtube.com/@m1zar)
...
Ask Zaroc bot (The moon icon at the right down corner) to Download Zaroc Library, try something like (I Wanna Download the library)
Or Click [**HERE for 1.4**](https://drive.google.com/drive/folders/1sSO0tbUDtdGyeb741G1Oi3HUMnka7TDN?usp=sharing)
...
> - Look at the Tutorial Again or check the [**Video Tutorial**](https://www.youtube.com/watch?v=426Ltaeferk&list=PLpVijIXbyeMO5OwECKbsIbGI1k2jvKnSX&index=22)
