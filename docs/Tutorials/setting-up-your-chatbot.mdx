...
Or **Look at this Tutorial in Spanish** with **[Mizar](https://www.youtube.com/watch?v=8xQ2h5sV-_w&list=PLpVijIXbyeMMxCgN7gMRpu-WNlXXb9Xv7&index=2)**.
...
On your root folder, Unpack the file, and you will have a folder named Chatbots with Zaroc and Kael(a chatbot template)
...
Now, lets check that Kael (chatbot template) is requiring Zaroc
