...
Or **Look at this Tutorial in Spanish** with **[Mizar](https://www.youtube.com/watch?v=DgJc-w94BUQ&list=PLpVijIXbyeMMxCgN7gMRpu-WNlXXb9Xv7&index=3)**.
...
$wsTextArray = ["Message from the backend"];
