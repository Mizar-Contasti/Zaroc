...
> - Available webBlocks are **accordeon button chips description image list paragraph** These can be located in blocks -> webBlocks
...
$imageArray = array("imageurl");
$aTitleArray = array("Card Title");
$aSubtitleArray = array("Card Subtitle");
$aTextArray = array("Card Accordeon Text");

$bTitleArray = array("Button Title 1","ButtonTitle2");
$bCustomArray = array("button Custom 1","button Custom 2");
$bIconArray = array("Button Icon","Button Icon 2");
$bColorArray = array("#00efff","#000fff");
...
$components = array(
    ...
    array(),
    array($imageArray,$aTitleArray,$aSubtitleArray,$aTextArray),
    array(),
