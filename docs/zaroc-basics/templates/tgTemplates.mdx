...
> - Available tgBlocks are **image text reply card** These can be located in blocks -> tgBlocks.
...
$tgTextArray = array("Text Title 1");

$cImageArray = array("https://ramenparados.com/wp-content/uploads/2018/06/Barakamon-destacado-1000x600.jpg");
$cTitleArray = array("CardTitle");
$cSubtitleArray = array("Card subtitle");
$cButtonTextArray = array(array("button1","button2"));
$cButtonCustomArray = array(array("button1","button2"));

$structure = array('text','comma','card');
$components = array(
    array($tgTextArray),
    array(),
    array($cImageArray,  $cTitleArray,  $cSubtitleArray,  $cButtonTextArray,  $cButtonCustomArray)
);
