...
![Example of Two Paragraph](./../../../static/img/blocks/wb/paragraph.jpg)
...
```php
$aImageArray = ["https://imageurl.com"];
$aTitleArray = ["Title"];
$aSubitleArray = ["Subtitle"];
$aTextArray = ["Subtitle"];
...
![Example of Two Cards](./../../../static/img/blocks/wb/card.jpg)
...
![Example of One Reply](./../../../static/img/blocks/wb/chips.jpg)
...
![Download this document](./../../../static/img/blocks/wb/list.jpg)
