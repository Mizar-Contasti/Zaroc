...
Entities in Dialogflow can be quite difficult at first. This tool helps us extract important information from the user.

There are 2 general types of entities, system entities, which are entities pre created by Dialogflow to handle common things like (Dates, Locations, Countries and more) On the other hand, we have custom entities, which are created by us for specific cases we want to implement or use.
...
<Tabs>
<TabItem value="synonims" label="Typed / Synonims">
...
> - To create Regular Exp we can take a look at this Regexp Generator [**HERE**](https://regexr.com/).

</TabItem>

<TabItem value="expansion" label="Automated Expansion">

> - Help us to expand the matches (synonymns), adding just a few of flexibility to the original text.

</TabItem>

<TabItem value="fuzzy" label="Fuzzy Matching">
...
**Check this Tutorial in Spanish** with **[Mizar](https://www.youtube.com/watch?v=6ZT4lH4HXsE&list=PLpVijIXbyeMO5OwECKbsIbGI1k2jvKnSX&index=25)**.
...
> - We can create a Entity named **orderFruits** that can handle **@buy_verb @quantity @fruits** entities.
