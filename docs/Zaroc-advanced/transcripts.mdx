...
> - Download [**transcripts.sql**](https://drive.google.com/file/d/1EKIRdqhJ3uGhLJgboveBrgMljGuHmqNj/view?usp=sharing) and Import it on your db to create the Sessions Table.
